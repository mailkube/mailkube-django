...
`mailkube-django` follows [Semantic Versioning](https://semver.org/). Security
...
[**"Report a vulnerability"**](https://github.com/mailkube/mailkube-django/security/advisories/new)
